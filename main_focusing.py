...
print(f"Original Reconstruction Time: {end_time - start_time:.2f} seconds", flush=True)
...
plt.axis('image')
plt.axis('off')
plt.savefig(f'nlos_reconstruction_original_id{id}.png', dpi=300, bbox_inches='tight')
print(f"Image saved to nlos_reconstruction_original_id{id}.png")